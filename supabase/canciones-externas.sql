...
insert into public.canciones
  ...
  ('can_0cb9d28dfa79', 'FRUITY', 'cli_msq2ogarwit0', 'GX3Q92312910', 'Externa', 0, 21, '2023-01-11', 'Fruity', 'https://cdn-images.dzcdn.net/images/cover/3909204d4eb1d985c1de82066b03e4d9/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ491. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ...
  ('can_0ee1b4244e9d', 'GLORYTROTTER', 'cli_msq2ogarwit0', 'QM6P42426862', 'Externa', 0, 21, '2024-06-12', 'GLORYTROTTER', 'https://cdn-images.dzcdn.net/images/cover/f95e196847c68a5d5f8f4244881e9f48/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ494. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_ca1adf5d497d', 'MONSTER', 'cli_msq2ogarwit0', 'QM7282460430', 'Externa', 0, 21, '2024-07-29', 'MONSTER', 'https://cdn-images.dzcdn.net/images/cover/483272af3bf01b58c183ade88f915545/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ530. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ...
  ('can_e5ecc0af703b', 'SEXXXTING', 'cli_msq454285v9b', 'GBLFP2405478', 'Externa', 0, 21, '2024-01-16', 'Sexxxting', 'https://cdn-images.dzcdn.net/images/cover/2706983d4e6aa1a63ccefd8beb9b6d1b/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ478. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ...
  ('can_d07c4736cf06', 'NOME ESTRESA', 'cli_msq454285v9b', 'UKXN22204127', 'Externa', 0, 21, '2022-08-04', 'Wavyyy South Sea', 'https://cdn-images.dzcdn.net/images/cover/69ee37f048a7508cf50615736045c3ac/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ473. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_6734b637c9b1', 'OLD EL PASO', 'cli_msq454285v9b', 'GX53U2080812', 'Externa', 0, 21, '2022-02-22', 'Sleepkey on the keykeyboard', 'https://cdn-images.dzcdn.net/images/cover/634d13bd6513a79d27e72c46680f00f3/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ484. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ...
  ('can_f8ad9a5baca5', 'OMG', 'cli_msq3zyjxtowk', 'QZFZ72453512', 'Externa', 0, 21, '2024-02-02', 'OMG', 'https://cdn-images.dzcdn.net/images/cover/551a065126c8f193ea94ed81ba7ba763/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ505. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_bae99606e606', 'THUGLIFE', 'cli_msq3zyjxtowk', 'QZTB32349261', 'Externa', 0, 21, '2023-11-26', '#THUGLIFE', 'https://cdn-images.dzcdn.net/images/cover/10c64b00ee5b2785fb72b1d7ae4cdf11/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ501. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ...
  ('can_bb724ec42266', 'BAPESTA', 'cli_msq2ogarwit0', 'QM6MZ2430838', 'Externa', 0, 21, '2024-04-12', 'BAPESTA', 'https://cdn-images.dzcdn.net/images/cover/0e3fa68d4c37897352708f336be1557e/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ496. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_c33546ad5bc4', 'OSIRIS', 'cli_msq3zyjxtowk', 'QZHN72463888', 'Externa', 0, 21, '2024-03-20', 'OSIRIS', 'https://cdn-images.dzcdn.net/images/cover/bab6d20cdec8b88159a0ac85758697ea/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ468. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_375d41e19c61', 'TATIANA', 'cli_msq3zyjxtowk', 'QZWFL2394263', 'Externa', 0, 21, '2023-12-17', 'TATIANA', 'https://cdn-images.dzcdn.net/images/cover/9e19b55ddd9844eeb71c8aa457223490/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ466. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_9181bcdf9c0b', 'VAPE KING', 'cli_msq3zyjxtowk', 'QZFYZ2394134', 'Externa', 0, 21, '2023-01-12', 'VAPE KING (feat. 8BELIAL)', 'https://cdn-images.dzcdn.net/images/cover/dbdcfebc4347a2d716d8a764595bfcdd/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ504. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_fee71c7801cb', 'WTF', 'cli_msq3zyjxtowk', 'QZES72303399', 'Externa', 0, 21, '2023-03-05', 'WTF!', 'https://cdn-images.dzcdn.net/images/cover/af654dae33e85d426ab0a3e38ee61b6f/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ465. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ...
  ('can_5d1e6246b0a5', 'LADYGAGGA', 'cli_msq2f4vzvoyj', 'QZES82400686', 'Externa', 0, 21, '2024-02-26', '#LadyGagga', 'https://cdn-images.dzcdn.net/images/cover/0ec320729f4fdc9c33b59c6c95e436dd/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ463. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_025e6a06f78e', 'SEXYJEANS', 'cli_msq2f4vzvoyj', 'QZFYY2446418', 'Externa', 0, 21, '2024-01-05', '#SEXYJEANS', 'https://cdn-images.dzcdn.net/images/cover/e2dd491d55b59a03e68132c8c417c6d1/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ462. Distribuida fuera de ADA; ISRC y release de Deezer.'),
  ('can_7519e34353f6', 'THEMELON', 'cli_msq2f4vzvoyj', 'QM6MZ2497722', 'Externa', 0, 21, '2024-04-26', '#THEMELON', 'https://cdn-images.dzcdn.net/images/cover/57fbded2f7cd8b6e9dae5af90c624a31/250x250-000000-80-0-0.jpg', 'Obra UMPG DDJ464. Distribuida fuera de ADA; ISRC y release de Deezer.')
